...
const Calculator = () => {
    ...
    const handleSignToggle = () => {
        const toggleTotal = total.startsWith('-') ? total.slice(1) : '-' + total;
        setTotal(toggleTotal);
    ...
    return (
        <div className='h-screen bg-dark flex justify-center items-center'>
            <div className='h-content w-80 bg-light-gray rounded-xl'>
                ...
                <div className='h-1/5'>
                    <button className='w-1/4 text-4xl p-3 bg-plum-purple opacity-80' value='AC' onClick={handleClear}>AC</button>
                    <button className='w-1/4 text-4xl p-3 bg-plum-purple opacity-80' value='' onClick={handleSignToggle}>+/-</button>
                    <button className='w-1/4 text-4xl p-3 bg-plum-purple opacity-80' value='%'>%</button>
                    <button className='w-1/4 text-4xl p-3 bg-orange opacity-80' value='/' onClick={() => handleDigitClick('/')}>{'\u00F7'}</button>
                </div>
                <div className='h-1/5'>
                    ...
                    <button className='w-1/4 text-4xl p-3 bg-orange opacity-80' value='*' onClick={() => handleDigitClick('*')}>X</button>
                </div>
                <div className='h-1/5'>
